				...
				<view class="mescroll-wxs-content" :style="{'transform': translateY, 'transition': transition}" :change:prop="wxsBiz.callObserver" :prop="callProp">
					...
					<view v-if="mescroll.optDown.use" class="mescroll-downwarp" :style="{'background':mescroll.optDown.bgColor,'color':mescroll.optDown.textColor}">
						<view class="downwarp-content">
							...
							<view v-else class="downwarp-progress">
								<image class="downwarp-man mescroll-wxs-man" :style="{'transform':downRotate}" src="https://www.mescroll.com/img/jingdong/mescroll-progress1.png" mode="widthFix"/>
								<image class="downwarp-box mescroll-wxs-box" :style="{'transform':downRotate}" src="https://www.mescroll.com/img/jingdong/mescroll-progress0.png" mode="widthFix"/>
							</view>
					...
					<view v-if="mescroll.optUp.use && !isDownLoading && upLoadType!==3" class="mescroll-upwarp" :style="{'background':mescroll.optUp.bgColor,'color':mescroll.optUp.textColor}">
						...
						<view v-show="upLoadType===1">
							<view class="upwarp-progress">
								<view class="upwarp-loading mescroll-rotate"></view>
							</view>
...
<script>
	...
	export default {
		...
		computed: {
			...
			// 缩放比例
			downRotate() {
				return this.downLoadType === 1 ? 'scale('+this.downRate+','+this.downRate+')' : '';
			},
			// 文本提示
			downText() {
