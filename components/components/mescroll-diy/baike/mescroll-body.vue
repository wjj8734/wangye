<template>
	<view 
		...
		<view class="mescroll-body-content mescroll-wxs-content" :style="{ transform: translateY, transition: transition }" :change:prop="wxsBiz.callObserver" :prop="callProp">
			...
			<!-- <mescroll-down :option="mescroll.optDown" :type="downLoadType" :down-hight="downHight"></mescroll-down> -->
			<view v-if="mescroll.optDown.use" class="mescroll-downwarp" :style="{'background':mescroll.optDown.bgColor,'color':mescroll.optDown.textColor}">
				<view class="downwarp-content">
					<view class="mescroll-wxs-progress" :class="[isDownLoading ? 'downwarp-load-start' : 'downwarp-load']" :style="{ height: downLoadHeight }"></view>
...
<script>
	...
	export default {
		...
		computed: {
			...
			isDownLoading() {
				return this.downLoadType === 2 || this.downLoadType === 3;
			},
			// 下拉刷新进度的高度,模拟下拉时小人被拉出的感觉
			downLoadHeight(){
				return this.downLoadType === 1 ? this.downHight/2+"px" : '50px'
			}
		},
		methods: {
